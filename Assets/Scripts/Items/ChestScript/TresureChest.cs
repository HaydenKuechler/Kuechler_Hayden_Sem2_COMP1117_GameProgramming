...
public class TreasureChest : MonoBehaviour, IInteractable
{
    ...
    [SerializeField] private GameObject gemPrefab;     // Ability to add prefab 
    ...
    private void Awake()
    {
        sRend = GetComponent<SpriteRenderer>();         // Caching your reference of Sprite 
    }
